...
<?php $this->load->view('_partials/navbar.php'); ?>
    <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl " id="navbarBlur" data-scroll="false">
        <div class="container-fluid py-1 px-3">
            ...
            <h6 class="font-weight-bolder text-white mb-0">Mutasi Penduduk</h6>
            </nav>
        </div>
    </nav>
              ...
              <div class="table-responsive p-2">
                ...
                <thead>
                  ...
                  <tr>
                        ...
                        <td>Kelurahan <?=$data->kelurahan_baru;?> , <?=$data->kota_baru;?></td>
                        <td><a href="<?=base_url('/pindah/detail/'.$data->id); ?>">detail</a></td>
                    </tr>
                    <?php }; ?>
                  </tbody>
...
<div class="modal fade" id="ModalData" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" data-backdrop="static" data-keyboard="false">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
          ...
          <form action="<?=base_url('Pindah/add')?>" method="post">
