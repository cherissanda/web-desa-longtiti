      ...
      <div class="row">
            <div class="col-12">
                <div class="card mb-4">
                        ...
                        <div class="card-body">
                                <form id="pendudukForm" action="<?=site_url('Pindah/update/'.$penduduk->id); ?>" enctype="multipart/form-data" method="post">
                                        <div class="row">
                                                <div class="col-md-6">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6 ">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" value="<?=isset($penduduk->kelurahan_baru) ? $penduduk->kelurahan_baru : ' ' ?>" class="form-control" id="kelurahan_baru" name="kelurahan_baru" required>
                                                        </div>
                                                ...
                                                <div class="col-md-6">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="text" value="<?=isset($penduduk->kota_baru) ? $penduduk->kota_baru : ' ' ?>" class="form-control" id="kota_baru" name="kota_baru" required>
                                                                    </div>
                                                    </div>
