      ...
      <div class="row">
        <div class="col-12">
          <div class="card mb-4">
                ...
                <div class="col-md-3">
                <a href="<?=base_url('/penduduk/edit/'.$penduduk->id) ?>"class="btn btn-primary btn-sm ms-auto">
                            <i class="fa fa-pencil"></i>
                </a>
                <button class="btn btn-danger btn-sm ms-auto" id="deleteButton">
        ...
        $('#deleteButton').click(function(){
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    window.location.href = "<?php echo site_url('penduduk/delete/'.$penduduk->id); ?>";
                } else {
