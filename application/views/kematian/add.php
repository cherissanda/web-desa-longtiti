      ...
      <div class="row">
            <div class="col-12">
                <div class="card mb-4">
                        ...
                        <div class="card-body">
                                <form id="pendudukForm" action="<?=site_url('kematian/update/'.$penduduk->id); ?>" enctype="multipart/form-data" method="post">
                                        <div class="row">
                                                <div class="col-md-6">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="file" class="form-control" name="surat_meninggal" <?=(!empty($_FILES['surat_meninggal']['name']) || empty($penduduk->surat_meninggal)) ? 'required' : ''; ?>>
                                                        </div>
                                                    </div>
