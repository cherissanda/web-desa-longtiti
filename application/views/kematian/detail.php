      ...
      <div class="row">
        <div class="col-12">
          <div class="card mb-4">
                ...
                <div class="col-md-3">
                <a href="<?=base_url('/kematian/edit/'.$penduduk->id) ?>"class="btn btn-primary btn-sm ms-auto">
            ...
            <div class="row">
                    ...
                    <div class="row">
                        <div class="col-md-6 ">
                                <div class="form-group">
                                    ...
                                    <input type="text" value="<?=$penduduk->tanggal_kematian?>" class="form-control" id="tanggal_kematian" name="tanggal_kematian" disabled>
                                </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                                ...
                                <iframe src="<?=base_url(empty($penduduk->file) ? 'images/no_data.png' : 'images/' . $penduduk->file); ?>" width="100%" height="400px"></iframe>     
