...
<?php $this->load->view('_partials/navbar.php'); ?>
    <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl " id="navbarBlur" data-scroll="false">
        <div class="container-fluid py-1 px-3">
            ...
            <h6 class="font-weight-bolder text-white mb-0">Surat Keterangan Domisili</h6>
            </nav>
        </div>
    </nav>
          ...
          <div class="card mb-4">
                  <div class="card-header pb-0">
                      <div class="d-flex align-items-center mb-0">
                        <p>Preview Surat Keterangan Domisili</p>
                      </div>
                  </div>
                  <div class="card-body">
                        <div class="row preview">
                          <?php $this->load->view('surat/surat_domisili/layoutSurat.php'); ?>
                        </div>
...
$(document).ready(function() {
    ...
    function myFunction() {
        ...
        formData.append('alamat', alamat);
          ...
          fetch("<?=site_url('surat/storeSuratDomisili')?>", { 
                method: 'POST',
                headers: {
