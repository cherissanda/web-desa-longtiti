...
$(document).ready(function() {
    ...
    function myFunction() {
        ...
        var alamat_asal = document.getElementById("alamat_asal").innerHTML.trim();
        var kelurahan_baru = document.getElementById("kelurahan_baru").innerHTML.trim();
        var kota_baru = document.getElementById("kota_baru").innerHTML.trim();
        ...
        formData.append('kelurahan_baru', kelurahan_baru);
        formData.append('kota_baru', kota_baru);

          console.log(formData);

          fetch("<?=site_url('surat/storeSuratPindah')?>", { 
                method: 'POST',
                headers: {
