...
<table class="MsoNormalTable" border="0" cellspacing="0" cellpadding="0" style="margin-left:.9pt;border-collapse:collapse">
    <tbody width="100%">
        ...
        <tr>
            ...
            <td>
                <p class="MsoNormal"><span style="font-family: Arial ,sans-serif" id="alamat">
                <?=isset( $penduduk->rt) ? $penduduk->alamat .' , RT '. $penduduk->rt .' / RW '.$penduduk->rw : $penduduk->alamat?>
                </span></p>
            </td>
        </tr>
        <tr>
            ...
            <td>
                <p class="MsoNormal"><span style="font-family: Arial ,sans-serif" id="nik"><?=$penduduk->nik?></span></p>
            </td>
        </tr>
    </tbody>
</table>
...
<span style="font-family: Arial ,sans-serif">
Yang bersangkutan tersebut diatas benar – benar warga Desa Long Titi dan telah Meninggal Dunia di Desa Long Titi, pada 
<span id=tanggal_kematian>
    <?=date("d-m-Y",strtotime($penduduk->tanggal_kematian))?>
</span> berdasarkan Keterangan RT setempat</span></p>
